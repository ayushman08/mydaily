...
public class EditCrewsListAdapter extends ArrayAdapter<CrewsDataList> {
    ...
    public EditCrewsListAdapter(Context context, int textViewResourceId,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(
                    R.layout.edit_crews_list_item, null);
            holder = new CrewsListRowHolder();
            holder.userNameEditText = (EditText) convertView.findViewById(R.id.user_name_text_view);
            holder.userProfileImageView = (CircleImageView) convertView.findViewById(R.id.user_profile_image_view);
            holder.userJobFunctionEditText = (EditText) convertView.findViewById(R.id.user_job_text_view);
        ...
        try {
            holder.userNameEditText.setText(mCrewsDataList.getFirstname() + " " + mCrewsDataList.getLastname());

            if (mCrewsDataList.getCrewImageDatas().getImage_path() != null) {
