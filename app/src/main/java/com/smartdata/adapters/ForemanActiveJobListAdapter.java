...
public class ForemanActiveJobListAdapter extends ArrayAdapter<ForemanJobDataList> {
    ...
    public ForemanActiveJobListAdapter(Context context, int textViewResourceId,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(
                    R.layout.foreman_active_job_list_item, null);
            ...
            holder.mStatusTextView = (TextView) convertView.findViewById(R.id.status_text_view);
        ...
        try {
            ...
            if (mForemanJobDataList.getJob_detail().getStart_date() != null) {
                ...
                if (mUtility.changeDate(mForemanJobDataList.getJob_detail().getStart_date()).equals(new SimpleDateFormat(Constants.InputTag.DATE_FORMAT).format(Calendar.getInstance().getTime()))) {
                    holder.mStatusTextView.setText(mContext.getResources().getString(R.string.new_status));
                } else {
                    holder.mStatusTextView.setText("");
                }
