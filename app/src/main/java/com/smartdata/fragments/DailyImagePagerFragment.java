...
public class DailyImagePagerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mDailiesImageArrayList = myApplication.getmDailiesImageArrayList();
    ...
    private class ImageAdapter extends PagerAdapter {
        ...
        @Override
        public int getCount() {
            return mDailiesImageArrayList.size();
        }
        ...
        public Object instantiateItem(ViewGroup view, int position) {
            ...
            ImageLoader.getInstance().displayImage(Constants.WebServices.BASE_URL + mDailiesImageArrayList.get(position).getImage_path(), imageView, options, new SimpleImageLoadingListener() {
                @Override
