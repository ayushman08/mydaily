...
import com.smartdata.interfaces.SwipeCallback;
...
public class ListViewSwipeGesture implements OnTouchListener {
    ...
    private void GetResourcesValues() {
        ...
        HalfDrawable = activity.getResources().getDrawable(R.drawable.user);
        FullDrawable = activity.getResources().getDrawable(R.drawable.user);
    }
