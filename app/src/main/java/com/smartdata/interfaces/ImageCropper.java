...
public class ImageCropper {
    ...
    public static final int REQUEST_PICTURE_FROM_GALLERY = 1123;
    public static final int REQUEST_PICTURE_FROM_CAMERA = 1124;
    public static final int REQUEST_CROP_PICTURE = 1125;
     ...
     * onActivityResult() of the ImageCropper for handling result and being notified.
     */
    ...
    public ImageCropper(Activity mContext) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if ((requestCode == REQUEST_PICTURE_FROM_GALLERY) && (resultCode == Activity.RESULT_OK)) {
            ...
            try {
                Bitmap bitmap = decodeFile(tempUriFromSource.getPath());
                if (bitmap != null) {
                    tempFileFromSource = new File(tempUriFromSource.toString());
                    Bitmap rotatedBitmap = ExifUtil.rotateBitmap(tempUriFromSource.getPath(), bitmap);
                    tempUriFromSource = getImageUri(mContext, rotatedBitmap);
    ...
    public void selectImageFromGallery() {
        ...
        if (tempFileFromSource == null) {
            try {
                ...
                tempFileFromSource.setWritable(true, false);
   ...
   /* public Uri getImageUri(Context inContext, Bitmap inImage) {
    ...
    /**
     * Listener interface for receiving callbacks from the ImageCropper.
     */
